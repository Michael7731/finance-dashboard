      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6">
            <p className="text-sm font-medium text-indigo-700">Demo credentials pre-filled</p>
            <p className="text-xs text-indigo-500 mt-0.5">Email: demo@example.com · Password: demo123</p>
          </div>
